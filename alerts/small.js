...
const Small = (props) => {
      ...
      return (
            <div>
                  ...
                  <br/>
                  {userName}'s emergency word is <i>'{keyword}'</i>. If they say <i>'{keyword}'</i> when you speak to them, it means they are in danger. If they communicate their safety word, or if you don't get any response from them after reaching out,<strong> please contact the authorities immediately.</strong>
                  <br/>
                  Stay Safe,
                  <br/>
                  The Pizza Now Team
